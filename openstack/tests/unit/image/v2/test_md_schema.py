...
from openstack.image.v2 import md_schema
...
class TestSchema(base.TestCase):
    def test_basic(self):
        sot = md_schema.MDSchema()
        self.assertIsNone(sot.resource_key)
        self.assertIsNone(sot.resources_key)
        self.assertEqual('/schemas/metadef', sot.base_path)
    ...
    def test_make_it(self):
        sot = md_schema.MDSchema(**EXAMPLE)
        ...
        self.assertEqual(EXAMPLE['definitions'], sot.definitions_properties)
        self.assertEqual(EXAMPLE['required'], sot.required_properties)
